...
export const SUBJECTS: SubjectDefinition[] = [
  ...
  },
  {
    ...
    note: '추가 제공 예정',
    description: '추가 제공 예정',
    scope: '공통수학Ⅰ, 공통수학Ⅱ, 대수, 확률과 통계 사용',
    solverInstruction:
      '공통수학Ⅰ, 공통수학Ⅱ, 대수, 확률과 통계 범위 안에서만 풀이한다. 미적분과 기하(벡터 등) 개념은 사용하지 않는다.',
  },
  {
    id: 'geometry',
    label: '기하',
    ...
    note: '추가 제공 예정',
    description: '추가 제공 예정',
    scope: '공통수학Ⅰ, 공통수학Ⅱ, 대수, 기하 사용',
    solverInstruction:
      '공통수학Ⅰ, 공통수학Ⅱ, 대수, 기하 범위 안에서만 풀이한다. 미적분과 확률과 통계 개념은 사용하지 않는다.',
  },
  {
    id: 'calculus-2',
    label: '미적분Ⅱ',
    ...
    note: '추가 제공 예정',
    description: '추가 제공 예정',
    scope: '공통수학Ⅰ, 공통수학Ⅱ, 대수, 미적분Ⅰ, 미적분Ⅱ 사용',
    solverInstruction:
      '공통수학Ⅰ, 공통수학Ⅱ, 대수, 미적분Ⅰ, 미적분Ⅱ 범위 안에서만 풀이한다. 기하(벡터 등)와 확률과 통계 개념은 사용하지 않는다.',
  },
];
